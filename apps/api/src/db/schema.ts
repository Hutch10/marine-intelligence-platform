...
export const databaseSchema: DatabaseTableSchema[] = [
  ...
  },
  {
    ...
    columns: [
      ...
      { name: "sea_temp_observed_at", type: "integer", nullable: true },
      { name: "wave_height_observed_at", type: "integer", nullable: true },
      { name: "wind_observed_at", type: "integer", nullable: true },
      { name: "pressure_observed_at", type: "integer", nullable: true },
      { name: "sea_surface_temp_backfilled", type: "integer", defaultValue: "0" },
      { name: "wave_height_backfilled", type: "integer", defaultValue: "0" },
      { name: "provenance_id", type: "text", nullable: true },
      { name: "sync_status", type: "text", defaultValue: "'synced'" },
  ...
  {
    name: "environmental_harness_events",
    columns: [
      { name: "id", type: "text", primaryKey: true },
      ...
      { name: "parent_event_id", type: "text", nullable: true },
      { name: "root_event_id", type: "text" },
      { name: "signal_id", type: "text", nullable: true },
    ...
    indexes: [
      { name: "idx_harness_events_kind_created", columns: ["event_kind", "created_at"] },
      { name: "idx_harness_events_subject", columns: ["subject_type", "subject_id"] },
      { name: "idx_harness_events_root_created", columns: ["root_event_id", "created_at"] },
      { name: "idx_harness_events_signal_created", columns: ["signal_id", "created_at"] },
      { name: "idx_harness_events_alert_created", columns: ["alert_id", "created_at"] },
    ],
  },
];
